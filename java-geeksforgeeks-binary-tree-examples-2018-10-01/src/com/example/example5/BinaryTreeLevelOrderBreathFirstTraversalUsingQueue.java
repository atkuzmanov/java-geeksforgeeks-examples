...
class BinaryTreeLevelOrderBreathFirstTraversalUsingQueue {
    ...
    public static void main(String args[])
    {
        /* creating a binary tree and entering
         the nodes */
        BinaryTreeLevelOrderBreathFirstTraversalUsingQueue tree_level = new BinaryTreeLevelOrderBreathFirstTraversalUsingQueue();
